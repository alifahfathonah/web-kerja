...
class M_user extends CI_Model
{
    ...
    public function get_all_user_nonaktif()
    {
        $hasil = $this->db->query("SELECT * FROM user JOIN user_detail ON user.id_user_detail = user_detail.id_user_detail 
         WHERE id_user_level = 3 AND user_detail.id_status_aktif = 1 AND user_detail.nama_lengkap IS NOT NULL ");
        return $hasil;
    }

    public function get_all_user_aktif()
    {
        $hasil = $this->db->query("SELECT * FROM user JOIN user_detail ON user.id_user_detail = user_detail.id_user_detail 
         WHERE id_user_level = 3 AND user_detail.id_status_aktif = 2 AND user_detail.nama_lengkap IS NOT NULL");
        return $hasil;
    }
    ...
    {
        $hasil = $this->db->query("SELECT * FROM user WHERE id_user_level = 1 AND id_user='$id_user'");
        return $hasil;
    }
    ...
    public function cek_login($username)
    {
        ...
        $hasil_user = $this->db->query("SELECT * FROM user WHERE username='$username'");
        return $hasil_user;
